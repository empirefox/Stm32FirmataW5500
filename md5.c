...
//  F, G, H, I
//
//  The basic MD5 functions. F and G are optimised compared to their RFC 1321
//  definitions for architectures that lack
...
//  counters. There are no alignment
//  requirements.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void* TransformFunction(Md5Context* ctx,
                               void const* data,
                               uintmax_t size) {
  uint8_t* ptr;
  uint32_t a;
...
//  internal state of the context. Keep on
//  calling this function until all the data has been added. Then call
//  Md5Finalise to calculate the hash.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Md5Update(Md5Context* Context,  // [in out]
  ...
  if (BufferSize >= 64) {
    Buffer =
        TransformFunction(Context, Buffer, BufferSize & ~(unsigned long)0x3f);
    BufferSize &= 0x3f;
  }
...
//  buffer containing 128bit hash). After
//  calling this, Md5Initialised must be used to reuse the context.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Md5Finalise(Md5Context* Context,  // [in out]
                 MD5_HASH* Digest      // [in]
) {
  uint32_t used;
  uint32_t free;
